...
export default function Details({id}) {
  ...
  useEffect(() => {
    ...
    fetch(`http://127.0.0.1:8000/rea_of_id/${id}/`, {
      headers: {
  ...
  if (isLoading) return (<p className="w-full h-[100vh] flex justify-center items-center"> Loading...</p>);
  if (!detail)return (<p className="w-full h-[100vh] flex justify-center items-center">Error Data Not Found</p>);
  return (
    <div>
